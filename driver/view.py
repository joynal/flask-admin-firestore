...
class ModelView(BaseModelView):
    ...
    """
        ...
        or::
            ...
            class FilterLastNameBrown(BaseFirestoreFilter):
    ...
    """
        ...
        is slightly confusing, but that's how Flask-Firestore creates
    ...
    def scaffold_pk(self):
        # Firestore models have predefined 'id' as a key
        return 'id'
    ...
    def is_valid_filter(self, filter):
        """
            Validate if the provided filter is a valid Firestore filter

            :param filter:
                Filter object
        """
        return isinstance(filter, BaseFirestoreFilter)
    ...
    def _search(self, query, search_term):
        # TODO: Unfortunately, Firestore contains bug which
